...
The Zomato Analytics Dashboard helps users explore restaurant trends across multiple countries and cities.  
It analyzes restaurant counts, ratings, cuisines, price categories, customer votes, and booking availability.
...
The dataset used in this project was **provided by our coaching institute** as part of a data analytics learning program.  
The original public source was **not officially specified**.
...
- total restaurants, votes, average rating  
- top countries with maximum restaurants  
- city-wise distribution  
- top cuisines by popularity  
- rating range wise restaurant count  
...
- performing EDA on real-world business data  
- building KPIs and calculated measures  
